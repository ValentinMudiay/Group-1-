...
if(!empty($_GET['option_id']) AND !empty($_POST['upload_pics'])){

    require_once('v10-admin/gallery/upload-pics.php');
...
if (!empty($_GET['edit_gallery'])) {
    ...
    if (!empty($_POST['submit']) AND !empty($_POST['changeGalery']) AND ($_POST['chooseAction1'] == 1 OR $_POST['chooseAction1'] == 2 OR $_POST['chooseAction1'] == 4)) {
    ...
    elseif (!empty($_POST['submit']) AND $_POST['chooseAction1'] == 3) {


        //echo "DELETE PICS!<br>";
        require_once('v10-admin/gallery/delete-pics.php');
