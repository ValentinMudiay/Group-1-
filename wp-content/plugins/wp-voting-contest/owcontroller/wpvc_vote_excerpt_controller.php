...
if(!class_exists('WPVC_Vote_Excerpt_Controller')){

    class WPVC_Vote_Excerpt_Controller {
        ...
        public static function Instance($new = false) {
            if (self::$inst == null || $new) {
                self::$inst = new WPVC_Vote_Excerpt_Controller();
            }
            return self::$inst;
        }
        ...
        public function page_options() {
			...
			require_once(WPVC_VIEW_PATH.'wpvc_settings_excerpt_view.php');
			wpvc_settings_excerpt_view($this->name,$tag_list,self::$options_all_tags,$this->default_options);
		}
...
return new WPVC_Vote_Excerpt_Controller();
