...
(function(Da, P, l) {
    var O = function(g) {
        ...
        function Y(a) {
            ...
            F(function(a, b) {
                a.innerHTML = '<div class="wpvc_vote_dataTables_sizing" style="height:0;overflow:hidden;">' + C[b] + "</div>";
                a.style.width = A[b]
            }, x);
            J && F(function(a, b) {
                a.innerHTML = "";
        ...
        p = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    o.push(k);
                    k.oInstance = 1 === b.length ? b : g(this).wpvc_vote_dataTable();
                    db(d);
        ...
        g.extend(p.ext.classes, {
            ...
            sStripeOdd: "odd",
            sStripeEven: "even",
            sRowEmpty: "wpvc_vote_dataTables_empty",
            sWrapper: "wpvc_vote_dataTables_wrapper",
            sFilter: "wpvc_vote_dataTables_filter",
            sInfo: "wpvc_vote_dataTables_info",
            sPaging: "wpvc_vote_dataTables_paginate paging_",
            sLength: "wpvc_vote_dataTables_length",
            sProcessing: "wpvc_vote_dataTables_processing",
            ...
            sFilterInput: "",
            sLengthSelect: "",
            sScrollWrapper: "wpvc_vote_dataTables_scroll",
            sScrollHead: "wpvc_vote_dataTables_scrollHead",
            sScrollHeadInner: "wpvc_vote_dataTables_scrollHeadInner",
            sScrollBody: "wpvc_vote_dataTables_scrollBody",
            sScrollFoot: "wpvc_vote_dataTables_scrollFoot",
            sScrollFootInner: "wpvc_vote_dataTables_scrollFootInner",
            sHeaderTH: "",
            sFooterTH: "",
            sSortJUIAsc: "",
            sSortJUIDesc: "",
        ...
        g.extend(p.ext.oJUIClasses, p.ext.classes, {
            ...
            sPaging: "wpvc_vote_dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_",
            ...
            sScrollHead: "wpvc_vote_dataTables_scrollHead " + E,
            sScrollFoot: "wpvc_vote_dataTables_scrollFoot " + E,
            sHeaderTH: E,
            sFooterTH: E,
        ...
        g.fn.wpvc_vote_dataTable = p;
        g.fn.wpvc_vote_dataTableSettings = p.settings;
        g.fn.wpvc_vote_dataTableExt = p.ext;
        g.fn.DataTable = function(a) {
            return g(this).wpvc_vote_dataTable(a).api()
        };
        g.each(p, function(a, b) {
            g.fn.DataTable[a] = b
        });
        return g.fn.wpvc_vote_dataTable
    };
    "function" === typeof define && define.amd ? define("datatables", ["jquery"], O) : "object" === typeof exports ? O(require("jquery")) : jQuery && !jQuery.fn.wpvc_vote_dataTable && O(jQuery)
})(window, document);