jQuery(document).ready(function(){
    ...
    jQuery(document).on('change','#vote_onlyloggedinuser',function() {       
        if (jQuery('#vote_onlyloggedinuser').is(':checked')) {
            jQuery('.vote_grab_email_address').hide();
        }
        else{
            jQuery('.vote_grab_email_address').show();
        }
    });
    
    //#vote_tracking_method
    jQuery(document).on('change','#vote_tracking_method',function() {
        if (jQuery('#vote_onlyloggedinuser').is(':checked')) {
            jQuery('.vote_grab_email_address').hide();
        }
        else{
            if(this.value == 'email_verify'){
                jQuery('.vote_grab_email_address').hide();
            }
            else{
                jQuery('.vote_grab_email_address').show();
    ...
    jQuery('#wpvc_delete_current_theme').click(function(event){	
        var current_theme= jQuery('#owt_color_select').val();	
        jQuery('.save_as_template_col').html('<input type="text" name="wpvc_delete_current_theme_flag" id="wpvc_delete_current_theme_flag" value="1" />');		
    });   
    ...
    jQuery('#owt_color_select').change(function(){
        ...
        jQuery('#wpvc_loader_image').show();
        var value = this.value;	 
        if (wpvc_default_theme.includes(value)) {
            jQuery('#wpvc_delete_current_theme').hide();
        }
        else{
            jQuery('#wpvc_delete_current_theme').show();
        }
        
        var data = {
                'action': 'wpvc_render_accordion',
                'color': value
            };
...
jQuery(document).ready(function($){
    $("#mobile-toggle-menu").click(function(){
        ...
        $(".wpvc_settings_menu").toggleClass( "show" );
    });
});