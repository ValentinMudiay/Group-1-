<?php
if(!function_exists('wpvc_settings_excerpt_view')){
	function wpvc_settings_excerpt_view($thisname,$tag_list,$options_all_tags,$default){
		wp_enqueue_script($thisname . '_script', WPVC_ASSETS_JS_PATH. 'wpvc_votes-advanced-excerpt.js');
		$tag_cols = 5;
		extract($default, EXTR_SKIP);
		?>
		<h2 class="color_h2"><?php _e('Excerpt Settings','voting-contest'); ?></h2>
