<?php
if(!function_exists('wpvc_voting_shortcode_startcontest_view')){
    function wpvc_voting_shortcode_startcontest_view($contest_args){
			...
			if($time != '0' && $time) {
				...
				<div class="wpvc_countdown_wrapper">
					<div class="wpvc_countdown_desc_wrapper countdown_enddesc_wrapper">
						<div class="wpvc_countdown_tag"><?php _e('Voting Starts In:','voting-contest'); ?></div>
					</div>
