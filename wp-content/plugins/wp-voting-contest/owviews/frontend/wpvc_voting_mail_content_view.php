<?php
if(!function_exists('wpvc_voting_mail_addcontestant_view')){
    function wpvc_voting_mail_addcontestant_view($option_setting,$post_id,$cont_details,$email_description = null,$flag=null){
		...
		$message .='
          ...
          <body style="margin: 0; padding: 0; background: #4b4b4b;" bgcolor="#4b4b4b">
			...
			if($flag == null){
				...
				if($flag == null){						
                $message .='<p style="color:#767676; font-weight: normal; margin: 0; padding: 0; line-height: 20px; font-size: 12px;font-family: Helvetica, Arial, sans-serif;"><a href="'.$admin_url.'">Click here</a> to view the entry</p><br/>';
				}
...
if(!function_exists('wpvc_voting_mail_verification_code')){
    function wpvc_voting_mail_verification_code($verificationcode){
